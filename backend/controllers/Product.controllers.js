...
const updateProduct = async (req, res) => {
    ...
    if (!mongoose.Types.ObjectId.isValid(id)) {
        console.log('From Update: The Product does not found');
    ...
    try {
        ...
        console.log('Product has been updated successfully:', updatedProduct);
        res.status(200).json({ success: true, message: 'The product updated successfully', data: updatedProduct })
    } catch (error) {
